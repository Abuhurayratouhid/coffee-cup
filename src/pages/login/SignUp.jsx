...
const SignUp = () => {
    ...
    const { userCreate, googleLogin } = useContext(AuthContext)
        ...
        <div style={{
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Button onClick={handleGoogleLogin} style={{ width: '100%', marginTop: '1rem' }} variant='contained'><GoogleIcon></GoogleIcon></Button>
                </Box>
            </Box>
